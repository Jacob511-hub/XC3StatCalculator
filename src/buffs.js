const buffs = [
    ...
    { name: "Awakening", boostType: "multiplierDamage", group: "reduction", flags: ["awakeningEnemy"], boostAmount: 25},
    ...
    { name: "Reduce All", boostType: "multiplierDamage", group: "reduction", flags: ["reduceAll"], boostAmount: -50},
]