...
const gems = [
    ...
    { name: "Steel Protection", src: "img/equipment/gems/gem-blue.png", boostType: "additive", boostStat: "block", boostAmount: 30, description: function() {return `Increases Block Rate by ${variableAmountGems} percentage points.`;}},
    ...
    { name: "Accurate Grace", src: "img/equipment/gems/gem-red.png", boostType: "additive", boostStat: "dexterity", boostAmount: 45, description: function() {return `Increases Dexterity by ${variableAmountGems}.`;}},
    ...
    { name: "Lifebearer", src: "img/equipment/gems/gem-green.png", boostType: "additive", boostStat: "healing", boostAmount: 45, description: function() {return `Increases Healing by ${variableAmountGems}.`;}},
    { name: "Soothing Breath", src: "img/equipment/gems/gem-green.png", boostType: "additive", boostStat: "healing", boostAmount: 15, boostAmountExtra: 45, description: function() {return `When helping an incapacitated ally, revives them with ${variableAmountGemsExtra}% more HP; also raises Healing by ${variableAmountGems}.`;}},
    { name: "Lifesaving Expertise", src: "img/equipment/gems/gem-green.png", boostType: "additive", boostStat: "healing", boostAmount: 15, boostAmountExtra: 45, description: function() {return `Boosts speed of ally revival by ${variableAmountGemsExtra}% and raises Healing by ${variableAmountGems}.`;}},
    ...
    { name: "Ironclad", src: "img/equipment/gems/gem-yellow.png", boostType: "additive", boostStat: "hp", boostAmount: 1500, description: function() {return `Increases maximum HP by ${variableAmountGems}.`;}},
