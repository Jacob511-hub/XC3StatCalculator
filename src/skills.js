...
const skillsSoulhacker = [
    { name: "None", src: "img/skills/skill-0.png"},
    { name: "Accelerating Attacks", src: "img/skills/skill-11.png", boostType: "multiplierDamage", group: "1", flags: ["quickMove"], boostAmount: 50, description: function() {return `Boosts damage dealt by ${variableAmountSkill}% when using an Art right after a Quick Move maneuver.`;}},
    ...
    { name: "Air Body", src: "img/skills/skill-1.png", boostType: "multiplier", boostStat: "agility", boostAmount: 30, description: function() {return `Boosts Agility by ${variableAmountSkill}%.`;}},
    { name: "Amazing Growth", src: "img/skills/skill-11.png", boostType: "multiplierDamageIncremental", group: "1", flags: ["timeElapsed"], boostIncrement: 0.5, boostMax: 60, description: function() {return `Boosts damage dealt based on the amount of battle time elapsed.`;}},
    ...
    { name: "Aquatic Warrior", src: "img/skills/skill-11.png", boostType: "multiplierDamage", group: "1", flags: ["inWater"], boostAmount: 50, description: function() {return `Boosts damage dealt by ${variableAmountSkill}% when in the water.`;}},
    ...
    { name: "Berserker Mindset", src: "img/skills/skill-11.png", boostType: "multiplierDamage", group: "1", flags: ["none"], boostAmount: 50, boostAmountExtra: 20, description: function() {return `Deal ${variableAmountSkill}% more damage but take ${variableAmountSkillExtra}% more damage.`;}},
    ...
    { name: "Terran Warrior", src: "img/skills/skill-11.png", boostType: "multiplierDamage", group: "1", flags: ["onLand"], boostAmount: 50, description: function() {return `Boosts damage dealt by ${variableAmountSkill}% when on land.`;}},
